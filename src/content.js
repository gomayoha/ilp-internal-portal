export const categories=['Leadership','Sales','Merchandising','Warehouse','Production','Product Development','Purchasing','Quality Control','Finance','Human Resources & Administration','Projects'];
