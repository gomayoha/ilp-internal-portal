...
create table public.portal_entries (
  ...
  category text check (category in ('Company & Policies','HR & Leave','Production & Planning','Prepress & Artwork','Quality & Compliance','Health & Safety','Purchasing & Logistics','Events & Announcements')),
...
create policy portal_files_read_admin on storage.objects for select to authenticated
